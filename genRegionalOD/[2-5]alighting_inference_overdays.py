...
#     # print(f'first_possible_alighting_stops:{first_possible_alighting_stops}\n')
#     second_boarding_equivalent_stops = equivalence_stops_dict.get(second_boarding_stop, [])
#     # print(f'second_boarding_equivalent_stops:{second_boarding_equivalent_stops}\n')
#     possible_alighting_stops = [stop for stop in second_boarding_equivalent_stops
#                                            if stop in first_possible_alighting_stops]
#     print(f'possible_alighting_stops:{possible_alighting_stops}')
#     if possible_alighting_stops:
#         first_ride_inferred_alighting_stop = possible_alighting_stops[0]
#     return first_ride_inferred_alighting_stop
...
def infer_alighting_stops(boarding_stop, stops_to_check, stop_name_dict):
    ...
    stops_to_check = list(set(stops_to_check) - {boarding_stop})
