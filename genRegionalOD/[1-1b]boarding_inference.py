            ...
            for i in range(len(group)):
                if pd.isnull(group.iloc[i]['上车站点名称']):
                    ...
                    if prev_stop_name and next_stop_name:
                        ...
                        prev_stops_diff = int(prev_time_diff.total_seconds() / 120)  # 真理就是2分钟过1站！
...
if __name__ == '__main__':
    ...
    while current_date <= end_date:
        ...
        save_folder = pathlib.Path("/Users/chalcozheng/PycharmProjects/pythonProject/IC_Smartcard/boarding_inference")
