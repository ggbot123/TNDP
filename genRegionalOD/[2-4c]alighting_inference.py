...
if __name__ == '__main__':
    # 读文件
    smartcard_data_folder = pathlib.Path("/Users/chalcozheng/PycharmProjects/pythonProject/IC_Smartcard/normalized_renamed_boarding")
    ...
    while current_date <= end_date:
        ...
        save_folder = pathlib.Path("/Users/chalcozheng/PycharmProjects/pythonProject/IC_Smartcard/OD")
